...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.dropSelf(ModBlocks.POLISHED_LIZALITE_STAIRS.get());
        this.dropSelf(ModBlocks.LIZALITE_WALL.get());
        this.dropSelf(ModBlocks.POLISHED_LIZALITE_WALL.get());
        this.dropSelf(ModBlocks.LIZALITE_TRAPDOOR.get());
        this.dropSelf(ModBlocks.POLISHED_LIZALITE_TRAPDOOR.get());
        this.dropSelf(ModBlocks.LIZALITE_PRESSURE_PLATE.get());
        this.dropSelf(ModBlocks.POLISHED_LIZALITE_PRESSURE_PLATE.get());
        this.dropSelf(ModBlocks.LIZALITE_BUTTON.get());
        this.dropSelf(ModBlocks.POLISHED_LIZALITE_BUTTON.get());
        ...
        this.add(ModBlocks.POLISHED_LIZALITE_DOOR.get(), 
            block -> createDoorTable(ModBlocks.POLISHED_LIZALITE_DOOR.get()));
    }
